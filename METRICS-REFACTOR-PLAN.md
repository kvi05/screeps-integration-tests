...
> **⚠️ ЗАМЕНЁН.** Актуальный план — [METRICS-CLASS-REFACTOR.md](./METRICS-CLASS-REFACTOR.md).  
> Этот файл оставлен для истории. Все изменения выполнены согласно новому плану.
